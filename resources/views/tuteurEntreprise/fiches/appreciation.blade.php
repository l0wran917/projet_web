          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauConnaissanceExcellent">
                <input type="radio" name="niveauConnaissance" id="inputNiveauConnaissanceExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauConnaissanceBon">
                <input type="radio" name="niveauConnaissance" id="inputNiveauConnaissanceBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauConnaissanceMoyen">
                <input type="radio" name="niveauConnaissance" id="inputNiveauConnaissanceMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauConnaissanceInsuffisant">
                <input type="radio" name="niveauConnaissance" id="inputNiveauConnaissanceInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauOrganisationExcellent">
                <input type="radio" name="niveauOrganisation" id="inputNiveauOrganisationExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauOrganisationBon">
                <input type="radio" name="niveauOrganisation" id="inputNiveauOrganisationBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauOrganisationMoyen">
                <input type="radio" name="niveauOrganisation" id="inputNiveauOrganisationMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauOrganisationInsuffisant">
                <input type="radio" name="niveauOrganisation" id="inputNiveauOrganisationInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPerseveranceExcellent">
                <input type="radio" name="niveauPerseverance" id="inputNiveauPerseveranceExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPerseveranceBon">
                <input type="radio" name="niveauPerseverance" id="inputNiveauPerseveranceBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPerseveranceMoyen">
                <input type="radio" name="niveauPerseverance" id="inputNiveauPerseveranceMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPerseveranceInsuffisant">
                <input type="radio" name="niveauPerseverance" id="inputNiveauPerseveranceInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauEfficaciteExcellent">
                <input type="radio" name="niveauEfficacite" id="inputNiveauEfficaciteExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauEfficaciteBon">
                <input type="radio" name="niveauEfficacite" id="inputNiveauEfficaciteBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauEfficaciteMoyen">
                <input type="radio" name="niveauEfficacite" id="inputNiveauEfficaciteMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauEfficaciteInsuffisant">
                <input type="radio" name="niveauEfficacite" id="inputNiveauEfficaciteInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauInteretExcellent">
                <input type="radio" name="niveauInteret" id="inputNiveauInteretExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauInteretBon">
                <input type="radio" name="niveauInteret" id="inputNiveauInteretBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauInteretMoyen">
                <input type="radio" name="niveauInteret" id="inputNiveauInteretMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauInteretInsuffisant">
                <input type="radio" name="niveauInteret" id="inputNiveauInteretInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPresentationExcellent">
                <input type="radio" name="niveauPresentation" id="inputNiveauPresentationExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPresentationBon">
                <input type="radio" name="niveauPresentation" id="inputNiveauPresentationBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPresentationMoyen">
                <input type="radio" name="niveauPresentation" id="inputNiveauPresentationMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPresentationInsuffisant">
                <input type="radio" name="niveauPresentation" id="inputNiveauPresentationInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPonctualiteExcellent">
                <input type="radio" name="niveauPonctualite" id="inputNiveauPonctualiteExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPonctualiteBon">
                <input type="radio" name="niveauPonctualite" id="inputNiveauPonctualiteBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPonctualiteMoyen">
                <input type="radio" name="niveauPonctualite" id="inputNiveauPonctualiteMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauPonctualiteInsuffisant">
                <input type="radio" name="niveauPonctualite" id="inputNiveauPonctualiteInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauAssiduiteExcellent">
                <input type="radio" name="niveauAssiduite" id="inputNiveauAssiduiteExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauAssiduiteBon">
                <input type="radio" name="niveauAssiduite" id="inputNiveauAssiduiteBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauAssiduiteMoyen">
                <input type="radio" name="niveauAssiduite" id="inputNiveauAssiduiteMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauAssiduiteInsuffisant">
                <input type="radio" name="niveauAssiduite" id="inputNiveauAssiduiteInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauExpressionExcellent">
                <input type="radio" name="niveauExpression" id="inputNiveauExpressionExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauExpressionBon">
                <input type="radio" name="niveauExpression" id="inputNiveauExpressionBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauExpressionMoyen">
                <input type="radio" name="niveauExpression" id="inputNiveauExpressionMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauExpressionInsuffisant">
                <input type="radio" name="niveauExpression" id="inputNiveauExpressionInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauSociabiliteExcellent">
                <input type="radio" name="niveauSociabilite" id="inputNiveauSociabiliteExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauSociabiliteBon">
                <input type="radio" name="niveauSociabilite" id="inputNiveauSociabiliteBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauSociabiliteMoyen">
                <input type="radio" name="niveauSociabilite" id="inputNiveauSociabiliteMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauSociabiliteInsuffisant">
                <input type="radio" name="niveauSociabilite" id="inputNiveauSociabiliteInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauCommunicationExcellent">
                <input type="radio" name="niveauCommunication" id="inputNiveauCommunicationExcellent" value="4" required> Excellent
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauCommunicationBon">
                <input type="radio" name="niveauCommunication" id="inputNiveauCommunicationBon" value="3" required> Bon
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauCommunicationMoyen">
                <input type="radio" name="niveauCommunication" id="inputNiveauCommunicationMoyen" value="2" required> Moyen
              </label>
            </div>
            <div class="col-xs-2 text-center">
              <label class="radio-inline" for="inputNiveauCommunicationInsuffisant">
                <input type="radio" name="niveauCommunication" id="inputNiveauCommunicationInsuffisant" value="1" required> Insuffisant
              </label>
            </div>
            </div>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="form-group">
                ...
                <div class="col-xs-10">
                  <textarea name="embauchePourquoi" class="form-control" id="inputEmbauchePourquoi" rows="2" cols="40" required></textarea>
                </div>
              </div>
            </div>
          </div>
